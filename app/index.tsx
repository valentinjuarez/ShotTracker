  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#06101E" }}>
      <ScrollView
        ...
        contentContainerStyle={{ paddingHorizontal: isCompact ? 16 : 22, paddingBottom: 40 }}
      >
        ...
        <Animated.View style={[{ paddingTop: 18, paddingBottom: 20, gap: 16 }, heroAnim]}>
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
            <View style={{ flex: 1, gap: 8 }}>
              ...
              <Text style={{ color: "rgba(255,255,255,0.72)", fontSize: 16, lineHeight: 24 }}>
                Registra sesiones de tiro, mide tus porcentajes y revisa tu progreso con un flujo simple, rapido y
                pensado para entrenar mejor.
              </Text>
            </View>
          ...
          <View style={{ flexDirection: isCompact ? "column" : "row", gap: 12 }}>
            <Link href="/(auth)/login" asChild>
              <Pressable style={{ flex: 1 }}>
                <PrimaryButton icon="log-in-outline" label="Abrir app" />
              </Pressable>
            </Link>

            <Link href="mailto:soporte@shottracker.app" asChild>
              <Pressable style={{ flex: 1 }}>
        ...
        >
          ...
          <View style={{ flexDirection: isCompact ? "column" : "row", gap: 12, marginTop: 6 }}>
            <Link href="/privacy" asChild>
              <Pressable style={{ flex: 1 }}>
                <SecondaryButton icon="document-text-outline" label="Ver privacidad" />
              </Pressable>
            </Link>
            <Pressable
...
function PrimaryButton({ icon, label }: { icon: keyof typeof Ionicons.glyphMap; label: string }) {
  return (
    <View
      style={{
        minHeight: 52,
    ...
    >
      <Ionicons name={icon} size={18} color="#08111F" />
      <Text style={{ color: "#08111F", fontSize: 15, fontWeight: "900" }}>{label}</Text>
    </View>
  );
}
